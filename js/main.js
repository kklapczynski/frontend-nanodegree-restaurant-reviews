...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoia2tsYXBjenluc2tpIiwiYSI6ImNqcW1hcmx3aTBheHk0OG11MDBuOWFiZzAifQ.iaDMo3GDB5VMwn1Fiv95Xg',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  image.alt = DBHelper.description(restaurant);
  li.append(image);
